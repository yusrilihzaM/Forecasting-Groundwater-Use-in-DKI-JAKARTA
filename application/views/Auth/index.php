            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mb-5">
                        <a href="<?=base_url()?>" class="logo"><img src="<?=base_url()?>assets/images/logo-light.png"
                                width="50%" alt="logo"></a>
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="p-2">
                                ...
                                <div class="flash-data-news1"
                                    data-flashdata="<?= $this->session->flashdata('flash1') ?>">
                                ...
                                <h5 class="mb-5 text-center">Silakan masuk untuk melanjutkan</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="mt-4 text-center">
                                                <a href="<?=base_url()?>auth/registration" class="text-muted"><i
                                                        class="mdi mdi-account-circle mr-1"></i> Buat Akun</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
